...
ActionSwap2: true
ActionSwap2-IconKeywords: true
Bartender4: true

TransparentChatBubbles: true
EmoteCenter: disabled
LFGStatusIcon: true

InspectEquip: disabled
IQ: true
ShowItemLevel: true
!InspectFix: disabled
Reforgenator: true
...
SavedInstances: true
TillerTracker: disabled
DailyGlobalCheck: disabled
DailyGlobalCheck_HallowsEnd: disabled
DailyGlobalCheck_Professions: disabled
DailyGlobalCheck_WorldBosses: disabled
...
ButtonBin: true
ChocolateBar: true
ChocolateBar_Options: true
DockingStation: true
DockingStation_Config: true
StatBlockCore: disabled
