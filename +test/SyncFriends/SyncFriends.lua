--[[
Copyright (c) 2009-2011 Vincent Pelletier
...
function SyncFriends:OnEnable()
    ...
    -- or adding a non-existent player from/to friend list will polute the
    -- pool.
...
function SyncFriends:setKnownBy(playerName)
    ...
    if not playerData then
        error(tostring(playerName).." is not ni pool, cannot set it known "..
            "by current toon")
    end
