...
function MT:eventHandler(this, event, arg1, ...)
	if event == "ADDON_LOADED" then
		if arg1 == "MacroToolkit" then
			_G.SLASH_MACROTOOLKIT_CMD1 = MT.slash .. "mt"
			_G.SLASH_MACROTOOLKIT_CMD2 = MT.slash .. "mac"
			_G.SLASH_MACROTOOLKIT_CMD3 = MT.slash .. "mtoolkit"
			_G.SLASH_MACROTOOLKIT_CMD4 = MT.slash .. "macrotoolkit"
