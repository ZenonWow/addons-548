...
|cff808080(Hold shift to skip confirmation)|r]=],
	...
	LIST_TITLE = "|cffcccc88DevPad|r",
	LUA_TOGGLE = "Toggle Lua mode for this script.",
	RECEIVE_CONFIRM_SCRIPT_FORMAT = [=[%s has sent you a script called |cff808080“%s”|r.  Add it to your |cffcccc88DevPad|r?
|cffff1111WARNING: Inspect all untrustworthy scripts before you run them!|r]=],
	RECEIVE_CONFIRM_FOLDER_FORMAT = [=[%s has sent you a folder called |cff808080“%s”|r.  Add it and its contents to your |cffcccc88DevPad|r?
|cffff1111WARNING: Inspect all untrustworthy scripts before you run them!|r]=],
...
|cff808080(Hold shift for reverse)|r]=],
	SEND = [=[Send this script or folder to other |cffcccc88DevPad|r users.
