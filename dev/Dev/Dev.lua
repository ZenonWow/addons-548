...
function NS:MODIFIER_STATE_CHANGED ( _, Modifier, State )
	...
	if ( GetModifiedClick( "DEV_ENABLECONSOLE" ):find( Modifier, 1, true ) ) then
		SetConsoleKey( State == 1 and "`" or nil );
	end
	if ( GetModifiedClick( "DEV_FRAMES_INTERACTIVE" ):find( Modifier, 1, true ) ) then
...
SlashCmdList[ "DEV_TOGGLEADDON" ] = NS.ToggleAddOnSlashCommand;