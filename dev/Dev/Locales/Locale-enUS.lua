...
_DevLocalization = setmetatable( {
	...
	-- ToggleMod
	TOGGLEADDON_ERROR_FORMAT = "|cffcccc88Dev|r: Error loading AddOn “%s”: %s."; -- AddonName, ErrorMessage


	-- Dump
	DUMP_MESSAGE_FORMAT = "|cffcccc88Dev|r.Dump: %s";
	...
	DUMP_LVALUE_DEFAULT = "|cffcccc88Dev|r.Dump";
	...
	-- Outline
	OUTLINE_MESSAGE_FORMAT = "|cffcccc88Dev|r.Outline: %s";
	...
	-- Frames
	FRAMES_MESSAGE_FORMAT = "|cffcccc88Dev|r.Frames: %s";
...
-- Bindings
BINDING_HEADER_DEV = "Dev";

BINDING_NAME_DEV_RELOADUI = "Reload UI";
BINDING_NAME_DEV_OPENCHATSCRIPT = "Open Script";

-- Stats: Rename the old FPS binding instead of making a new one
BINDING_NAME_TOGGLEFPS = "Toggle Dev.Stats";
...
-- Dump
-- /dump is taken by Blizzard_DebugTools
SLASH_DEV_DUMP1 = "/dmp";
SLASH_DEV_DUMP2 = "/d";
...
BINDING_NAME_DEV_FRAMESTOGGLE = "Toggle Frames Browsing";