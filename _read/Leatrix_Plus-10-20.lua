...
--	Create event frame
	...
	function LpEvt:SetRegisterEvent(featureEnabled, eventList)
		if  featureEnabled  and  featureEnabled ~= "Off"  then
			for  i = 1,#evt  do  self:RegisterEvent(eventList[i])  end
		else
			for  i = 1,#evt  do  self:UnregisterEvent(eventList[i])  end
		end
	end
...
--	Lock and dim invalid options
	function LeaPlusLC:SetDim()
		...
		-- Whisper invite
		lockItem = LeaPlusLC["InviteFromWhisper"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["InvWhisperBtn"],lockItem)

		-- Player chains
		lockItem = (LeaPlusLC["ShowPlayerChain"] ~= LeaPlusDB["ShowPlayerChain"]) or LeaPlusLC["ShowPlayerChain"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["ModPlayerChain"],lockItem)

		-- Protect privacy
		lockItem = (LeaPlusLC["AchieveControl"] ~= LeaPlusDB["AchieveControl"]) or LeaPlusLC["AchieveControl"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["CharOnlyAchieves"],lockItem)

		-- Battle.net friend request blocking
		lockItem = (LeaPlusLC["ManageBnetReq"] ~= LeaPlusDB["ManageBnetReq"]) or LeaPlusLC["ManageBnetReq"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["BlockBnetReq"],lockItem)

		-- Spell icons
		lockItem = (LeaPlusLC["ShowSpellIcons"] ~= LeaPlusDB["ShowSpellIcons"]) or LeaPlusLC["ShowSpellIcons"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["SpellIconsBtn"],lockItem)

		-- Frame options
		lockItem = (LeaPlusLC["FrmEnabled"] ~= LeaPlusDB["FrmEnabled"]) or LeaPlusLC["FrmEnabled"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["MoveFramesButton"],lockItem)

		-- World map modification button
		lockItem = (LeaPlusLC["ShowMapMod"] ~= LeaPlusDB["ShowMapMod"]) or LeaPlusLC["ShowMapMod"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["MapOptBtn"],lockItem)

		-- Automatically toggle nameplates
		lockItem = (LeaPlusLC["AutoEnName"] ~= LeaPlusDB["AutoEnName"]) or LeaPlusLC["AutoEnName"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["ModEnPanelBtn"],lockItem)

		-- Manage emote sounds
		lockItem = (LeaPlusLC["ManageRestedEmotes"] ~= LeaPlusDB["ManageRestedEmotes"]) or LeaPlusLC["ManageRestedEmotes"] == "Off"
		...
		lockItem = (LeaPlusLC["ManageTradeGuild"] ~= LeaPlusDB["ManageTradeGuild"]) or LeaPlusLC["ManageTradeGuild"] == "Off"
		...
		lockItem = LeaPlusLC["AutoRepairOwnFunds"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["AutoRepairGuildFunds"],lockItem)

		-- Viewport
		lockItem = (LeaPlusLC["ViewPortEnable"] ~= LeaPlusDB["ViewPortEnable"]) or LeaPlusLC["ViewPortEnable"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["ModViewportBtn"],lockItem)

		-- Minimap customisation
		lockItem = (LeaPlusLC["MinimapMod"] ~= LeaPlusDB["MinimapMod"]) or LeaPlusLC["MinimapMod"] == "Off"
		LeaPlusLC:LockItem(LeaPlusCB["ModMinimapBtn"],lockItem)

		-- Coordinates
		lockItem = (LeaPlusLC["StaticCoordsEn"] ~= LeaPlusDB["StaticCoordsEn"]) or LeaPlusLC["StaticCoordsEn"] == "Off"
...
--	The Live bit
	function LeaPlusLC:Live()
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["InviteFromWhisper"] == "On", {
			'CHAT_MSG_WHISPER',
			'CHAT_MSG_BN_WHISPER',
		})
		...
		SetCVar( "ffxGlow", LeaPlusLC["NoGlowEffect"] == "On" and '0' or '1' )

		----------------------------------------------------------------------
		--	Disable death effect
		----------------------------------------------------------------------

		SetCVar( "ffxDeath", LeaPlusLC["NoDeathEffect"] == "On" and '0' or '1' )

		----------------------------------------------------------------------
		--	Disable special effects
		----------------------------------------------------------------------

		LpEvt:SetRegisterEvent( LeaPlusLC["NoSpecialEffects"] == "On", {
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["NoDuelRequests"] == "On", {
			'DUEL_REQUESTED',
		})
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["NoPetDuels"] == "On", {
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["NoPartyInvites"] == "On" or LeaPlusLC["AcceptPartyFriends"] == "On", {
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["AutoReleaseInBG"] == "On", {
			'PLAYER_DEAD',
		})
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["AutoAcceptRes"] == "On", {
			'RESURRECT_REQUEST',
		})
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["AutoAcceptSummon"] == "On", {
			'CONFIRM_SUMMON',
		})
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["AutoAcceptQuests"] == "On" or (LeaPlusLC["AutoAcceptQuests"] == "On" and LeaPlusLC["AcceptOnlyDailys"] == "On"), {
			'QUEST_DETAIL',
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["AutoSellJunk"] == "On" or LeaPlusLC["AutoRepairOwnFunds"] == "On", {
			'MERCHANT_SHOW',
		})
		...
		LpEvt:SetRegisterEvent( LeaPlusLC["NoConfirmLoot"] == "On", {
			'CONFIRM_LOOT_ROLL',
		...
		if event == "QUEST_PROGRESS" then
			if ((LeaPlusLC["AutoTurnInQuests"] == "On" and LeaPlusLC["TurnInOnlyDailys"] == "Off") or (LeaPlusLC["AutoTurnInQuests"] == "On" and LeaPlusLC["TurnInOnlyDailys"] == "On" and QuestIsDaily() == 1)) then
				if  not IsShiftKeyDown()  and  IsQuestCompletable()  then
					...
					if  LeaPlusLC.questReadyID ~= questID  then
						LeaPlusLC.questReadyID = questID
						-- Turn in quest
						LeaPlusLC:Print("Auto complete quest=".. tostring(questID) .." ".. GetQuestLink(LeaPlusLC.questCompleteID))
						CompleteQuest()
					else
						-- Avoid infinite recursion
						LeaPlusLC:Print("Repeated QUEST_PROGRESS: quest=".. tostring(questID) .." ".. GetQuestLink(LeaPlusLC.questCompleteID))
					end
				end
			end
			LeaPlusLC.questReadyID = false
			return
		end
		...
		if event == "QUEST_COMPLETE" then
			if ((LeaPlusLC["AutoTurnInQuests"] == "On" and LeaPlusLC["TurnInOnlyDailys"] == "Off") or (LeaPlusLC["AutoTurnInQuests"] == "On" and LeaPlusLC["TurnInOnlyDailys"] == "On" and QuestIsDaily() == 1)) then
				if not IsShiftKeyDown() and GetNumQuestChoices() <= 1 then
					...
					local questID = GetQuestID()
					if  LeaPlusLC.questCompleteID ~= questID  then
						LeaPlusLC.questCompleteID = questID
						-- Take reward, forget quest
						LeaPlusLC:Print("Auto get reward for quest=".. tostring(LeaPlusLC.questCompleteID) .." ".. GetQuestLink(LeaPlusLC.questCompleteID))
						GetQuestReward(GetNumQuestChoices())
					else
						-- Avoid infinite recursion
						LeaPlusLC:Print("Repeated QUEST_COMPLETE: quest=".. tostring(LeaPlusLC.questCompleteID) .." ".. GetQuestLink(LeaPlusLC.questCompleteID))
					end
				end
			end
			LeaPlusLC.questCompleteID = false
			return
		end
