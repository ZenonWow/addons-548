...
function Binder_OnLoad(self)
	...
	-- 		tooltip:AddLine("Left Click: Open Frame");
	-- 		tooltip:AddLine("Hold Left Click: Move");
	-- 	end,
	-- };

	-- LibStub("LibDataBroker-1.1"):NewDataObject("BinderMinimapButton", minimapButton);
	-- LibStub("LibDBIcon-1.0"):Register("BinderMinimapButton", minimapButton, BinderMinimapSettings);
