...
--DEFAULT_CHAT_FRAME:AddMessage( 'self=' .. tostring(self) .. ' dataobj=' .. tostring(dataobj) )
end
...
function dataobj:DrawTooltip(anchor)
	if  not anchor  then  anchor= self  end
...
--[[
	...
	tooltip:SetCell(y, 1, C:White(L["Broker MicroMenu"]), "CENTER", 2)
...
--]]
	...
	tooltip:SetAutoHideDelay(0.001, anchor)
