...
private.L["CONFIG_ALERT_UNMUTE_DESC"] = "Временно включить звуки игры при показе кнопки NPCScan, чтобы вы могли услышать сигнал обнаружения."
...
private.L["CONFIG_DESC"] = "Эти параметры позволяют настроить способ оповещения, которым NPCScan привлечёт ваше внимание при обнаружении им редкого НИПа."
...
_G[ "BINDING_NAME_CLICK NPCScanButton:LeftButton" ] = [=[Выбрать последнее из найденных существ
|cff808080(Используйте когда NPCScan известит Вас)|r]=];