...
function HandyNotes:OnInitialize()
	...
	local function ToggleHandyNotes() LibStub("AceConfigDialog-3.0"):Open("HandyNotes") end
	self:RegisterChatCommand("hn", ToggleHandyNotes)
	self:RegisterChatCommand("handy", ToggleHandyNotes)
	self:RegisterChatCommand("handynotes", ToggleHandyNotes)
